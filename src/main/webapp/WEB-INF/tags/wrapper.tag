...
<html>
    <head>
        ...
        <link rel="stylesheet"  href="${pageContext.request.contextPath}/eonasdan-bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.min.css" type="text/css" />
        ...
        <script type="text/javascript" src="${pageContext.request.contextPath}/moment/moment.js"></script>
        <script type="text/javascript" src="${pageContext.request.contextPath}/bootstrap/js/bootstrap.min.js"></script>
        <script type="text/javascript" src="${pageContext.request.contextPath}/eonasdan-bootstrap-datetimepicker/build/js/bootstrap-datetimepicker.min.js"></script>
